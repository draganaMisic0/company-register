...
import InventoryListScreen from './InventoryListScreen.js';
    ...
    return (
        <Drawer.Navigator screenOptions={{
            ...
            options={{headerStyle:styles.header, headerRight: ()=> (
              ...
              <Icon name="search" type="ionicon" iconStyle={{marginRight:10}} />
              <Icon name="language" type="ionicon" iconStyle={{marginRight:10}} /></View> ), 
            ...
            options={{headerStyle:styles.header, drawerLabel: () => null, drawerIcon: ({ focused}) => <Icon name="people" type="ionicon" size={iconSize} color={focused ? activeColor : defaultColor}/>}}/>
            ...
            <Drawer.Screen  name="Inventory List" component={InventoryListScreen} 
